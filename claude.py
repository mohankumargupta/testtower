...
class TowerBuilder:
    ...
    def _get_additive_parts(self) -> List[Compound]:
        ...
        return [
            self.front()['add'] if 'add' in self.front() else Compound()
        ]
    ...
    def _get_subtractive_parts(self) -> List[Compound]:
        ...
        return [
            part['subtract'] 
            for part in [self.right(), self.back(), self.left()] 
            if 'subtract' in part
        ]
    ...
    def back(self):
        ...
        return { 
            'subtract': Compound([self.back_top()])
        }
    ...
    def back_top(self):
        ...
        """
        hole = (
            Plane.XZ.rotated((0,0,180)).offset(self.dims.width/2.0) * 
